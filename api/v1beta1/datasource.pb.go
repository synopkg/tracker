...
func file_api_v1beta1_datasource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1beta1_datasource_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WriteDataSourceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1beta1_datasource_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WriteDataSourceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
