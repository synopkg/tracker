...
func file_api_v1beta1_threat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1beta1_threat_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Threat); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1beta1_threat_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Mitre); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1beta1_threat_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1beta1_threat_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
